...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color.fromRGBO(125, 209, 212, 1);
  late Color secondary = const Color.fromRGBO(125, 209, 212, 1);
  late Color tertiary = const Color.fromRGBO(203, 202, 205, 1);
  late Color alternate = const Color.fromRGBO(255, 244, 241, 1);
  late Color primaryText = const Color(0xFF14181B);
  late Color secondaryText = const Color(0xFF14181B);
  late Color primaryBackground = const Color.fromRGBO(253, 255, 241, 1);
  late Color secondaryBackground = const Color.fromRGBO(253, 255, 241, 1);
  ...
  late Color error = const Color.fromRGBO(255, 150, 172, 1);
